...
public class SendMessage_withoutMessage {
    ...
    public  void sendMessageTest_inCorrectly() throws IOException {
       ...
       // form.SendMessage("Customer service","prueba@hot.com","1234",absolutePath+"\\testfileImage.jpg","");
       try {
           System.out.println(responseForm.getAlertErrorLabel());
           Assert.assertTrue(responseForm.getAlertErrorLabel().toLowerCase().contains("the message cannot be blank"));
       } catch (Exception e) {
