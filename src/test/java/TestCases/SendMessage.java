...
public class SendMessage {
     ...
     */
    @Test
    public  void sendMessageTest_correctly() throws IOException {
        ...
        form.SendMessage("Customer service","memail@test.com","1234",absolutePath+"\\testfileImage.jpg","Test challenge");
    ...
    public void recordFailure(ITestResult result){
        ...
        if(ITestResult.FAILURE == result.getStatus())
        {
            ...
            try{
                ...
                System.out.println(absolutePath + "/screenShots/" + result.getName() + ".png");
            }catch(IOException e){
                e.printStackTrace();
            }
        }
