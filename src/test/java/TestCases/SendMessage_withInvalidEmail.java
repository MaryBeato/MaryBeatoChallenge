...
public class SendMessage_withInvalidEmail {
    ...
    public  void sendMessageTest_inCorrectly() throws IOException {
      ...
      //  form.SendMessage("Customer service","test.com","1234",absolutePath+"\\testfileImage.jpg","Test challenge");
        try {
